(() => {
  ...
  function highlight(element) {
    ...
    var div2 = highlight.div;
    div2.style.transition = "background 2s";
    div2.style.backgroundColor = "rgba(241,231,64,.5)";
    const width = element.offsetWidth;
    const height = element.offsetHeight;
    div2.style.width = width + 8 + "px";
    div2.style.height = height + 8 + "px";
    div2.style.zIndex = element.style.zIndex + 1;
    ...
    div2.style.left = element.offsetLeft + (width - div2.offsetWidth) / 2 + "px";
    div2.style.top = element.offsetTop + (height - div2.offsetHeight) / 2 + "px";
    ...
    data: function() {
      return {
        ...
        tutorial: [
          ...
          {
            text: "The goal of the game is to get from one Wikipedia page to another as                            fast as possible by clicking the links in the page."
          },
          {
          ...
          {
            text: "3. Going back is not allowed, you have to find your way back by clicking links! Going back                            in the browser will just quit the game."
          },
          {
          ...
          {
            text: "Hint: It's often good to think about a 'hub' page from where you can navigate to the goal article easily.                           'United States' is often a good one."
          },
          {
