(() => {
  ...
  // static/js/modules/prompts/marathon-submit.js
  var MarathonBuilder = {
    props: ["admin"],
    components: {
    ...
    methods: {
      ...
      submitPrompt: async function() {
        try {
          if (this.startcp.length != 5)
            throw new Error("Need exactly 5 starting checkpoints. Add or remove starting checkpoints");
          if (this.cp.length < 40)
            throw new Error("Need 40 or more reserve checkpoints. Add more reserve checkpoints");
          if (this.admin) {
      ...
      submitAsCmty: async function() {
        const response = await fetchJson(
          "/api/community_prompts/submit_marathon_prompt",
          "POST",
          {
            "data": this.$data,
  ...
  // static/js/modules/prompts/sprint-submit.js
  var SprintBuilder = {
    props: ["admin"],
    components: {
      "prompt-generator": PromptGenerator,
  ...
  // static/js/modules/prompts/submitted-prompts.js
      ...
      async getPending() {
        try {
          ...
          this.pending.forEach(
            (el) => el["moment_str"] = import_moment.default.utc(el.submitted_time).fromNow()
          );
        } catch (e) {
          console.log(e);
        }
      ...
      async getApproved() {
        try {
          ...
          this.approved.forEach(function(el) {
            el["moment_str"] = import_moment.default.utc(el.submitted_time).fromNow();
            if (el.used) {
              el["publish_moment_str"] = import_moment.default.utc(el.active_start).fromNow();
            } else {
