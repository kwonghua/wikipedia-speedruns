(() => {
  ...
  // static/js/pages/lobbys/lobby.js
  var LOBBY_ID = serverData["lobby_id"];
  var successMessage = "Added prompt to lobby!";
  var app = new Vue({
    delimiters: ["[[", "]]"],
    el: "#app",
    components: {
...
Passcode: ${this.lobbyInfo.passcode}`;
      ...
      setMessage(messageType) {
        ...
        this.messageTimer = setTimeout(this.clearMessage, 5e3);
      },
