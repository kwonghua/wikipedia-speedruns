(() => {
  ...
  var require_confetti = __commonJS({
    "node_modules/canvas-confetti/src/confetti.js"(exports, module) {
      (function main(global2, module2, isWorker, workerSize) {
        ...
        function toDecimal(str2) {
          return parseInt(str2, 16);
        }
        function colorsToRgb(colors) {
          return colors.map(hexToRgb);
        }
        function hexToRgb(str2) {
          var val = String(str2).replace(/[^0-9a-f]/gi, "");
          if (val.length < 6) {
            ...
            while (temp--) {
              fettis.push(
                randomPhysics({
                  ...
                  shape: shapes[randomInt2(0, shapes.length)],
                  ticks,
                  decay,
                  gravity,
                  drift,
  ...
  // static/js/modules/game/finish.js
  ...
  // static/js/modules/game/runs.js
  async function updateAnonymousRun(runId, type = "sprint") {
    const reqBody = {
      "run_id": parseInt(runId)
    };
    try {
      const endpoint = type == "sprint" ? `/api/runs/update_anonymous` : `/api/quick_runs/update_anonymous`;
  ...
  // static/js/modules/localStorage/localStorage.js
  ...
  // static/js/modules/localStorage/localStorageQuickRun.js
  var location = "WS-S-quick-runs";
  ...
  // static/js/modules/localStorage/localStorageSprint.js
  ...
  // static/js/modules/achievements.js
  var import_moment = __toESM(require_moment());

  // static/achievements/metadata.js
  var achievement_list = {
    "meta": {
      display_name: "Meta",
      description: 'Visit "Wikipedia"',
      hidden: true
    },
    "bathroom": {
      display_name: "Bathroom Break",
      description: 'Visit "Bathroom"'
    },
    "ireland": {
      display_name: "Luck of the Irish",
      description: 'Visit "Ireland"'
    },
    "rome": {
      display_name: "All Roads Lead to Rome",
      description: 'Visit "Rome"'
    },
    "currency": {
      display_name: "Time is Money",
      description: 'Visit "Currency"'
    },
    "heart_of_darkness": {
      display_name: "Heart of Darkness",
      description: 'Visit "Leopold II of Belgium"'
    },
    "birds_and_bees": {
      display_name: "The Birds and the Bees",
      description: 'Visit "Intimate relationship"'
    },
    "emissionsgate": {
      display_name: "Emissionsgate",
    ...
    "conspiracy_theory": {
      display_name: "Jet Fuel Can't Melt Steel Beams",
      description: 'Visit "Conspiracy theory"'
    },
    "richard_nixon": {
      display_name: "I am not a Crook!",
      description: 'Visit "Richard Nixon"'
    },
    "sparta": {
      display_name: "This is Sparta!",
    ...
    "fastest_gun_alive": {
      ...
      description: "Finish a game with an average seconds per click of less than 10 seconds"
    },
    "carthago_delenda_est": {
      display_name: "Carthago Delenda Est",
      description: 'Visit these pages in the same game: "Third Punic War", "Cato the Elder"'
    },
    "square_one": {
      display_name: "Back to Square One",
      description: "Return to the starting page during a run",
      hidden: true
    },
    "usa": {
      display_name: "Land of the Free, Home of the Brave",
      description: 'Visit the page for "United States" 50 times'
    },
    "merseyside_derby": {
      display_name: "Merseyside Derby",
      description: 'Visit the page for "Liverpool F.C." "Everton F.C." in the same run'
    },
    "matrix": {
      display_name: "The Matrix Trilogy",
      description: 'Visit "The Matrix (franchise)", "Matrix (mathematics)", and "Toyota Matrix" all in a single run'
    },
    "friends": {
      display_name: "F.R.I.E.N.D.S",
      description: 'Visit the pages for these actors/actresses: "Jennifer Aniston", "Courteney Cox", "Lisa Kudrow", "Matt LeBlanc", "Matthew Perry", "David Schwimmer"'
    },
    ...
    "avengers": {
      ...
      description: 'Visit these pages in the same run: "Thor (Marvel Comics)", "Captain America", "Hulk", "Iron Man", "Black Widow (Marvel Comics)", "Hawkeye (Clint Barton)"'
    },
    "high_roller": {
      display_name: "High Roller",
      description: 'Reach "Gambling" via "Las Vegas"'
    },
    "marathon": {
  ...
  var achievement = {
    ...
    created: function() {
      ...
      this.progressPercent = parseInt(this.achievementdata["reached"] / this.achievementdata["out_of"] * 100);
      if (this.achieved) {
        this.progress = "Achieved " + import_moment.default.utc(this.achievementdata["time_reached"]).fromNow();
      } else {
  ...
  var achievement_storage = "lastAchievements";
  var achievements = {
    ...
    computed: {
      ...
      title() {
        if (this.isProfile)
          return `Achievements - ${this.achieved}/${this.total} Unlocked`;
        else {
          if (!this.isSprint)
            return `Unlock achievements in public prompts...`;
          if (!this.loggedIn)
            return `Login to check possible New Achievements!`;
          else
            return this.isEmpty ? `No new achievements unlocked` : this.count == 1 ? `${this.achieved} New Achievement!` : `${this.achieved} New Achievements!`;
        }
      }
    },
    methods: {
  ...
  // static/js/modules/confetti.js
  var confetti = require_confetti();
  var defaultColors = [
    "#26ccff",
    "#a25afd",
    "#ff5e7e",
  ...
  function fireworks(dur = 5) {
    ...
    var interval = setInterval(function() {
      ...
      confetti(Object.assign({}, defaults, { particleCount, origin: { x: randomInt(0.1, 0.3), y: Math.random() - 0.2 }, color: defaultColors, zIndex: 25e4 }));
      confetti(Object.assign({}, defaults, { particleCount, origin: { x: randomInt(0.7, 0.9), y: Math.random() - 0.2 }, color: defaultColors, zIndex: 25e4 }));
    }, 250);
  }

  // static/js/pages/play_finish.js
  var LOBBY_ID = serverData["lobby_id"] || null;
  var PLAYED = serverData["played"] || false;
  var RUN_ID = serverData["run_id"] || null;
...
//! momentjs.com
//! version : 2.29.4
//# sourceMappingURL=play_finish.js.map
